...
function PANEL:SetAtribIcon(text)
	...
	self.AttriImage:SetSize(45, 45)		
	self.AttriImage:SetImage("darkrpg/skills/none.png")
	if text == "Medizin" then -- Text = perk name, then image. Have fun - it sucks .
		self.AttriImage:SetImage("karman/skills/527329.png")
	elseif text == "Kraft" then
		self.AttriImage:SetImage("karman/skills/527485.png")
	elseif text == "Ausdauer" then
		self.AttriImage:SetImage("karman/skills/527577.png")
	elseif text == "Geschwindigkeit" then
		self.AttriImage:SetImage("karman/skills/Sprint.png")

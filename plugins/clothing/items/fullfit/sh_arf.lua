...
ITEM.name = "Box mit ARF Rüstungen.";
ITEM.category = "501st";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/tango_poison/501st/arf_501st_trooper.mdl"
ix.anim.SetModelClass("models/starwars/tango_poison/501st/arf_501st_trooper.mdl", "player")
ITEM.iconCam = {

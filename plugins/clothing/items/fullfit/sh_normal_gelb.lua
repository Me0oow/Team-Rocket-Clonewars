...
ITEM.name = "Box mit Gelber Klon Kleidung.";
ITEM.category = "Klontrooper";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
ITEM.model = "models/markus/custom/gameplay/objects/weaponcrate/weaponcrate_01_mesh.mdl"
ITEM.description = "Rechteckige weiße Schachtel mit Kleidung.";
ITEM.maxArmor = 150;
ITEM.gasImmunity = true
ITEM.replacements = "models/pg/phase1clones/trooperv2pg_codirt.mdl"
ix.anim.SetModelClass("models/pg/phase1clones/trooperv2pg_codirt.mdl", "player")
ITEM.iconCam = {

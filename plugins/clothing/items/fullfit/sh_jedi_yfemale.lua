...
ITEM.name = "Box mit Jedirobe (young Female).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/jazzmcfly/jka/younglings/jka_young_female.mdl"
ix.anim.SetModelClass("models/jazzmcfly/jka/younglings/jka_young_female.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Jedirobe (Armor).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/player/jedi_general_male_07.mdl"
ix.anim.SetModelClass("models/player/jedi_general_male_07.mdl", "player")
ITEM.iconCam = {

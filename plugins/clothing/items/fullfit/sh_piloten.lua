...
ITEM.name = "Box mit Piloten Rüstung.";
ITEM.category = "501st";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/pg/phase1clones/trooperpilotv2pg.mdl"
ix.anim.SetModelClass("models/pg/phase1clones/trooperpilotv2pg.mdl", "player")
ITEM.iconCam = {

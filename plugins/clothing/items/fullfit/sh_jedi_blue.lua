...
ITEM.name = "Box mit Jedirobe (Blue).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/templeguard/jedi_temple_04.mdl"
ix.anim.SetModelClass("models/templeguard/jedi_temple_04.mdl", "player")
ITEM.iconCam = {

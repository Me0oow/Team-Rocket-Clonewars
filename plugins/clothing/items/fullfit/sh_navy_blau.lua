...
ITEM.name = "Box mit Blauer Navy Kleidung.";
ITEM.category = "Navy";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/grady/navy/republic_navy_blue.mdl"
ix.anim.SetModelClass("models/starwars/grady/navy/republic_navy_blue.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Jedirobe (Purple).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/templeguard/jedi_temple_07.mdl"
ix.anim.SetModelClass("models/templeguard/jedi_temple_07.mdl", "player")
ITEM.iconCam = {

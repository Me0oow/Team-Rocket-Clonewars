...
ITEM.name = "Box mit Appo Rüstung.";
ITEM.category = "501st";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/tango_poison/501st/appo_501st_trooper.mdl"
ix.anim.SetModelClass("models/starwars/tango_poison/501st/appo_501st_trooper.mdl", "player")
ITEM.iconCam = {

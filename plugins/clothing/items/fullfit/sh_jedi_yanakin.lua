...
ITEM.name = "Box mit Jedirobe (young Anakin).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/jazzmcfly/jka/younglings/jka_young_anikan.mdl"
ix.anim.SetModelClass("models/jazzmcfly/jka/younglings/jka_young_anikan.mdl", "player")
ITEM.iconCam = {

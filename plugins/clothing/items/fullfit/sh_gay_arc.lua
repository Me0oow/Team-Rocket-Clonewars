...
ITEM.name = "Box mit Poisen Rüstung.";
ITEM.category = "501st";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/tango_poison/arc/arc_trooper.mdl"
ix.anim.SetModelClass("models/starwars/tango_poison/arc/arc_trooper.mdl", "player")
ITEM.iconCam = {

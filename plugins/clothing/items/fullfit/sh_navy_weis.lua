...
ITEM.name = "Box mit Weißer Navy Kleidung.(Krennic)";
ITEM.category = "Navy";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/grady/navy/republic_navy_admiral.mdl"
ix.anim.SetModelClass("models/starwars/grady/navy/republic_navy_admiral.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Schwarzer Navy Kleidung.";
ITEM.category = "Navy";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/grady/navy/republic_navy_black.mdl"
ix.anim.SetModelClass("models/starwars/grady/navy/republic_navy_black.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Lieutenant Rüstungen.";
ITEM.category = "Trooper";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/pg/phase1clones/trooperv2pg_ltdirt.mdl"
ix.anim.SetModelClass("models/pg/phase1clones/trooperv2pg_ltdirt.mdl", "player")
ITEM.iconCam = {

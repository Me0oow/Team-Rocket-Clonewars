...
ITEM.replacements = "models/starwars/tango_poison/501st/ph1_fs_trooper.mdl"
ix.anim.SetModelClass("models/starwars/tango_poison/501st/ph1_fs_trooper.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Jedirobe (young Male).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/jazzmcfly/jka/younglings/jka_young_male.mdl"
ix.anim.SetModelClass("models/jazzmcfly/jka/younglings/jka_young_male.mdl", "player")
ITEM.iconCam = {

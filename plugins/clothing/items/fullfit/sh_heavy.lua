...
ITEM.name = "Box mit Heavy Rüstungen.";
ITEM.category = "501st";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/starwars/tango_poison/501st/ph1_clone_heavy.mdl"
ix.anim.SetModelClass("models/starwars/tango_poison/501st/ph1_clone_heavy.mdl", "player")
ITEM.iconCam = {

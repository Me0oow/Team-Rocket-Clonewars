...
ITEM.name = "Box mit Jedirobe (Ahsoka).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/jazzmcfly/jka/ashoka/jka_ashoka.mdl"
ix.anim.SetModelClass("models/jazzmcfly/jka/ashoka/jka_ashoka.mdl", "player")
ITEM.iconCam = {

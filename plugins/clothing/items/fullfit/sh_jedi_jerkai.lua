...
ITEM.name = "Box mit Jedirobe (Jerkai).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/helios/custom/jerkai_t4lk.mdl"
ix.anim.SetModelClass("models/helios/custom/jerkai_t4lk.mdl", "player")
ITEM.iconCam = {

...
ITEM.name = "Box mit Jedirobe (young Shak).";
ITEM.category = "Jedi";
ITEM.flag = "A"
ITEM.width = 2
ITEM.height = 4
...
ITEM.replacements = "models/jazzmcfly/jka/younglings/jka_young_shak.mdl"
ix.anim.SetModelClass("models/jazzmcfly/jka/younglings/jka_young_shak.mdl", "player")
ITEM.iconCam = {

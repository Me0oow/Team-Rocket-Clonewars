ITEM.name = "Simples Pauldron";
ITEM.model = "models/fisher/parts/pauldron.mdl"
ITEM.price = 0;
ITEM.description = "Ab einem gewissen Rang kriegst du eins."
ITEM.outfitCategory = "simple";
ITEM.bodyGroups = {
	["pauldrons"] = 5,

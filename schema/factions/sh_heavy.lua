...
FACTION.name = "Heavy Platoon"
FACTION.description = "Das Heavy Platoon ist auf dem Schlachtfeld sehr stark. Sie unterstützen die Soldaten mit schwehren Waffen."

...
FACTION.name = "ARF"
FACTION.description = "Schnell, überlebensfähig und hocheffektiv im Nah- und Mittelbereich, dringen die Sturmtruppen unerbittlich vor und ebnen den Weg für den Rest der Einheiten."
